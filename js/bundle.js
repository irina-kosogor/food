...
window.addEventListener("DOMContentLoaded", () => {
  const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_4__.showModal)(".modal", modalTimerId), 50000);
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])(".timer", "2023-03-20");
});
})();
